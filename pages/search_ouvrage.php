...
<body>
	...
	<div id ="main"><br/>
	<h3>Recherche d'Ouvrage</h3>
	<form method ="post" action ="search_ouvrage_result.php">
	<p>
	<table align ="center">
	<tr><td><label for="titre1"> Titre du livre </label></td><td><input type="text" name="titre1" id="titre1" tabindex ="10"/></td></tr>
