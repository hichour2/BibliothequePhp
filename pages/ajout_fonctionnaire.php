...
<body>
	...
	<div id ="main"><br/>
	<h3>Ajouter un Fonctionnaire</h3><br/>
	<form method ="post" action ="inser_fonct.php">
	<p>
	<table class="ajout">
	
	<tr><td><label for="N_ord"> N° Ordre</label></td><td><input type="text" name="N_ord" id="N_ord"tabindex ="5"/></td></tr>
	...
	<tr><td><label for="service">Affectation </label></td><td><input type="text" name="service" id="service" tabindex ="15"/></td></tr>
	<tr><td><label for="function"> Fonction </label></td><td><input type="text" name="function" id="function"tabindex ="17"/></td></tr>
	<tr>
