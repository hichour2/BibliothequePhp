...
<body>
	...
	<div id ="main"><br/>
	<h3>Rechrche Etudiant</h3>
	<form method ="post" action ="search_etudiant_result.php">
	<p>
	<table align ="center">
	<tr><td><label for="CIN"> N° CIN </label></td><td><input type="text" name="CIN" id="CIN" tabindex ="10"/></td></tr>
