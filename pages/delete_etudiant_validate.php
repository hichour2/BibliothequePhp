...
<body>
	...
	<div id ="main"><br/>
	<p class="delete">
	VOULEZ VOUS VRAIMENT SUPPRIMER CET ETUDIANT <br/><br/>
	SI VOUS CLIQUEZ SUR SUPPRIMER <br/><br/>
	VOUS NE POURIEZ PLUS RECUPERRER CET ETUDIANT<br/><br/><br/>
	<a href ="delete_etudiant.php?N_CIN1=<?php echo $_GET['N_CIN1'];?>"> SUPPRIMER </a>
	</p>
