...
<body>
	...
	<div id ="main"><br/>
	<p class="delete">
	VOULEZ VOUS VRAIMENT SUPPRIMER CE THEME <br/><br/>
	SI VOUS CLIQUEZ SUR SUPPRIMER <br/><br/>
	VOUS NE POURIEZ PLUS RECUPERRER CE THEME <br/><br/><br/>
	<a href ="delete_categorie.php?ID_theme1=<?php echo $_GET['ID_theme1'];?>"> SUPPRIMER </a>
	</p>
