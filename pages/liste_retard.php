...
<body>
	...
	<h3>liste des Retardiers</h3>
	<table width ="800px" align="center">
	<tr><td>Fonctionnaire</td><td>Etudiant</td></tr>
	<tr> 
	<td>
	<?php
	$result1=$bdd->query('SELECT * FROM emprunter_f  WHERE date_de_retour <= CURDATE() ORDER BY date_de_retour ');
	?>
	...
	<td>
	<?php
	$result=$bdd->query('SELECT * FROM emprunter_e WHERE date_de_retour < CURDATE() ORDER BY date_de_retour ');
	?>
    <table class ="empruntlist" width ="400px">
	<tr><td> NOM </td><td> PRENOM </td><td> TITRE </td><td> Date de pret </td><td> Date prevu de retour </td></tr>
	<?php
