...
<body>
	...
	<div id ="main"><br/>
	<h3>Recherche de fonctionnaire</h3>
	<form method ="post" action ="search_fonctionnaire_result.php">
	<p>
	<table align ="center">
	<tr><td><label for="N_ord"> N° Ordre </label></td><td><input type="text" name="N_ord" id="N_ord" tabindex ="10"/></td></tr>
